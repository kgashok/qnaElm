...
var _user$project$Qna$decodeGifUrl = A2(
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Qna$decodeAnswer = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'answer',
...
var _user$project$Qna$encodeQuestion2 = F2(
	function (question, kBaseName) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'kid',
						_1: _elm_lang$core$Json_Encode$string(kBaseName)
					},
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Qna$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Qna$footer = A2(
...
var _user$project$Qna$sortAnswers = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(model.answer),
		_elm_lang$core$List$length(model.knowledgeBase)) > -1) ? {
		ctor: '_Tuple2',
...
var _user$project$Qna$Response = F3(
	function (a, b, c) {
		return {url: a, answer: b, score: c};
	});
var _user$project$Qna$answerScoreDecoder = function (url) {
	return A3(
		_elm_lang$core$Json_Decode$map2,
		_user$project$Qna$Response(url),
		A2(_elm_lang$core$Json_Decode$field, 'answer', _elm_lang$core$Json_Decode$string),
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (s) {
				var _p2 = _elm_lang$core$String$toFloat(s);
				if (_p2.ctor === 'Ok') {
...
var _user$project$Qna$expectUrlAndJson = function (response) {
	return A2(
		_elm_lang$core$Json_Decode$decodeString,
		_user$project$Qna$answerScoreDecoder(response.url),
		response.body);
};
var _user$project$Qna$decodeResponse = A4(
	_elm_lang$core$Json_Decode$map3,
	...
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (s) {
			var _p3 = _elm_lang$core$String$toFloat(s);
			if (_p3.ctor === 'Ok') {
...
var _user$project$Qna$getAnswer2 = function (model) {
	var settings_ = function (kurl) {
		return _elm_lang$core$Native_Utils.update(
			_user$project$Qna$postSettings,
			{
				...
				expect: _elm_lang$http$Http$expectStringResponse(_user$project$Qna$expectUrlAndJson)
			});
	};
	var sendRequest = function (qnaService) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Qna$NewAnswerResponse(qnaService.name),
			_elm_lang$http$Http$request(
				settings_(qnaService.url)));
	};
	return _elm_lang$core$Platform_Cmd$batch(
		A2(_elm_lang$core$List$map, sendRequest, model.knowledgeBase));
};
var _user$project$Qna$init = {
	ctor: '_Tuple2',
	_0: _user$project$Qna$initialModel,
	_1: _user$project$Qna$getAnswer2(_user$project$Qna$initialModel)
};
...
var _user$project$Qna$getAnswer3 = function (model) {
	var settings_ = function (kurl) {
		return _elm_lang$core$Native_Utils.update(
			_user$project$Qna$postSettings,
			{
	...
	var requests = _elm_lang$core$Platform_Cmd$batch(
		A2(
			_elm_lang$core$List$map,
			_elm_lang$http$Http$send(_user$project$Qna$NewResponse),
			A2(
				_elm_lang$core$List$map,
				_elm_lang$http$Http$request,
				A2(
...
var _user$project$Qna$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'MorePlease':
				...
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _user$project$Qna$getAnswer2(model_),
							_1: {
								ctor: '::',
			...
			case 'NewResponse':
				if (_p5._0.ctor === 'Ok') {
					var model_ = A2(_user$project$Qna$addResponse, model, _p5._0._0);
					return _user$project$Qna$sortAnswers(model_);
				} else {
					var model_ = A2(
						_user$project$Qna$addResponse,
...
var Elm = {};
Elm['Qna'] = Elm['Qna'] || {};
if (typeof _user$project$Qna$main !== 'undefined') {
    _user$project$Qna$main(Elm['Qna'], 'Qna', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Qna.Msg":{"args":[],"tags":{"NewAnswerResponse":["String","Result.Result Http.Error Qna.Response"],"Topic":["String"],"NewGif":["Result.Result Http.Error String"],"NewResponse":["Result.Result Http.Error Qna.Response"],"MorePlease":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Qna.Response":{"args":[],"type":"{ url : String, answer : String, score : Float }"}},"message":"Qna.Msg"},"versions":{"elm":"0.18.0"}});
}
