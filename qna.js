...
var _user$project$Version$version = 'v1.0-21-g94c5802';
...
if (typeof _user$project$Qna$main !== 'undefined') {
    _user$project$Qna$main(Elm['Qna'], 'Qna', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Qna.Msg":{"args":[],"tags":{"NewAnswer":["Result.Result Http.Error String"],"Topic":["String"],"NewGif":["Result.Result Http.Error String"],"MorePlease":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Qna.Msg"},"versions":{"elm":"0.18.0"}});
}
