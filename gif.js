...
var _user$project$Gif$kid = 'http://qnaElm';
var _user$project$Gif$Model = F2(
	function (a, b) {
		return {topic: a, gifUrl: b};
	});
var _user$project$Gif$Topic = function (a) {
	return {ctor: 'Topic', _0: a};
};
var _user$project$Gif$NewGif = function (a) {
...
var _user$project$Gif$getRandomGif = function (topic) {
	...
	var request = A2(_elm_lang$http$Http$get, url, _user$project$Gif$decodeGifUrl);
	return A2(_elm_lang$http$Http$send, _user$project$Gif$NewGif, request);
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(' Gif Generator'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Gif$Topic),
									_1: {ctor: '[]'}
								}
							}
						},
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Gif$MorePlease),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Gif$main = _elm_lang$html$Html$program(
	{
...
var Elm = {};
Elm['Gif'] = Elm['Gif'] || {};
if (typeof _user$project$Gif$main !== 'undefined') {
    _user$project$Gif$main(Elm['Gif'], 'Gif', undefined);
}
